    ...
    <>
      <section className="hero-atmosphere relative overflow-hidden text-cream">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
          ...
          <h1 className="font-display mt-5 max-w-3xl text-3xl leading-tight text-cream sm:text-4xl">
            {CIVIC_POST_TERMS_TITLE}
          </h1>
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-sand/85 sm:text-lg">
        ...
        <div className="grid gap-10 lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-12">
          <aside className="lg:sticky lg:top-24 lg:self-start">
            ...
            <nav className="mt-3 space-y-1 text-sm" aria-label="Terms sections">
              <a
                href="#summary"
                className="block py-1 text-navy hover:text-amber"
              >
                Key points
              </a>
              <a
              ...
              {CIVIC_POST_TERMS_SECTIONS.map((s) => (
                <a
                  ...
                  className="block truncate py-1 pl-3 text-muted hover:text-amber"
                >
                  {s.heading}
                </a>
              ))}
              <a href="#faqs" className="block py-1 text-navy hover:text-amber">
                FAQs
              </a>
              <a
                href="#contact"
          ...
          <div className="min-w-0">
            ...
            <section
              id="contact"
              className="mt-16 scroll-mt-24 border border-line bg-navy p-6 text-cream sm:p-8"
            >
              <h2 className="font-display text-2xl text-cream">
                Before you publish
              </h2>
              <p className="mt-3 max-w-2xl text-sm leading-relaxed text-sand/85">
