    ...
    >
      ...
      <div className="flex flex-wrap gap-2">
        <button
          type="submit"
          disabled={busy}
          className="bg-amber px-4 py-2.5 text-sm font-semibold text-navy hover:bg-amber-bright disabled:opacity-60"
        >
        ...
        <button
          ...
          className={`inline-flex items-center gap-1.5 border px-3 py-1.5 text-xs font-semibold transition ${
            signed
              ...
              : "border-amber bg-amber text-navy hover:bg-amber-bright"
          }`}
        >
        ...
        <button
          ...
          className={`min-h-11 px-5 py-2.5 text-sm font-semibold transition ${
            signed
              ...
              : "bg-amber text-navy hover:bg-amber-bright"
          }`}
        >
