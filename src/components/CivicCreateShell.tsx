    ...
    <div className="compose-focus relative min-h-[calc(100vh-3.5rem)]">
        ...
        <div className="mt-14 space-y-4">
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="rounded-full bg-navy px-6 py-3 text-sm font-semibold text-cream transition hover:bg-navy/90 disabled:opacity-40"
            >
      ...
      >
        <button
          ...
          className="w-full rounded-full bg-navy py-3 text-sm font-semibold text-cream disabled:opacity-40"
        >
          {publishing ? busyLabel : publishLabel}
        </button>
      </div>
