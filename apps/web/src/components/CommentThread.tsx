  ...
  async function saveEdit(id: string) {
    ...
    try {
      const res = await fetch(`/api/comments/${id}`, {
        ...
        body: JSON.stringify({
          body: editDraft.trim(),
          // Always send string so clearing a GIF actually clears media
          mediaUrl: editMedia.trim(),
          website: "",
        }),
      });
      const data = await res.json();
    ...
    <div className="mt-6 border-t border-line pt-6">
      ...
      >
        ...
        <button
          ...
          className="bg-chrome px-4 py-2 text-sm text-on-chrome hover:bg-chrome-mid disabled:opacity-60"
        >
        ...
        <div className="mt-2 space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              disabled={busy}
              onClick={onSaveEdit}
              className="bg-chrome px-3 py-1.5 text-xs text-on-chrome disabled:opacity-60"
            >
              Save
            </button>
            <button
        ...
        {isMine && !isEditing ? (
          <>
            <button
              ...
              className="ml-1 px-2 py-1 text-[11px] text-link hover:underline"
            >
              Edit
            </button>
            <button
        ...
        <div className="mt-3 space-y-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 bg-chrome px-3 py-1.5 text-xs text-on-chrome disabled:opacity-60"
            >
              <IconReply className="h-3.5 w-3.5" />
              Reply
            </button>
