      ...
      <header className="border-b border-line pb-8">
        ...
        <div className="mt-2 flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <p className="mt-2 break-all font-mono text-sm text-link">
              {profile.anonId}
            </p>
            {prefs.showOnlineHint && isSelf ? (
              <p className="mt-1 text-xs text-muted" title="From Settings → Privacy">
                Online status hint on (visible only to you for now)
              </p>
            ) : null}
          </div>
          <FollowButton
