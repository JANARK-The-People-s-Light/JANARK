...
export function ReportButton({
  ...
  const modal =
    open && mounted
      ? createPortal(
          <div
            className="fixed inset-0 z-[80] flex items-end justify-center bg-chrome/40 p-0 sm:items-center sm:p-4"
            role="presentation"
              ...
              {done ? (
                <div className="mt-6 space-y-4">
                  ...
                  <button
                    type="button"
                    onClick={() => setOpen(false)}
                    className="bg-chrome px-4 py-2 text-sm text-on-chrome hover:bg-chrome-mid"
                  >
                    Close
                  </button>
                </div>
