      ...
      {step === "idle" ? (
        <form onSubmit={requestOtp} className="mt-3 flex flex-col gap-2 sm:flex-row sm:flex-wrap">
          ...
          <button
            type="submit"
            disabled={busy}
            className="w-full bg-chrome px-4 py-3 text-sm text-on-chrome disabled:opacity-60 sm:w-auto sm:py-2"
          >
        ...
        <form onSubmit={verifyOtp} className="mt-3 space-y-2">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap">
            ...
            <button
              type="submit"
              disabled={busy}
              className="w-full bg-amber px-4 py-3 text-sm font-semibold text-on-amber disabled:opacity-60 sm:w-auto sm:py-2"
            >
