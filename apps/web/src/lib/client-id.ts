...
export function buildShareUrls(opts: {
  ...
  // Intent URLs for common share destinations (keys are Janark destination ids).
  return {
    feed: `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`,
    post: `https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodedText}`,
    chat: `https://wa.me/?text=${encodedText}%20${encodedUrl}`,
    stories: `https://www.instagram.com/`,
    network: `https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}`,
