...
data class TermsFaq(val id: String, val question: String, val answer: List<String>)

val CIVIC_POST_TERMS_SECTIONS = listOf(
    TermsSection(
        "1. Purpose of Janark",
        listOf(
    ...
    TermsSection(
        ...
        listOf("Posts should relate to the betterment of people and public life. Suitable topics include (non-exhaustive):"),
        listOf(
    ...
    TermsSection(
        ...
        listOf("In addition to the non-partisan rule, you agree not to publish content that:"),
        listOf(
    ...
    TermsSection(
        "14. Indemnity",
        listOf("You agree to defend, indemnify, and hold harmless Janark and its operators, maintainers, contributors, hosts, and affiliates from and against any claims, demands, actions, damages, losses, costs, and expenses (including reasonable legal fees) arising out of or related to:"),
        listOf(
...
val CIVIC_POST_TERMS_FAQS = listOf(
    TermsFaq("nonprofit", "Is Janark a non-profit organisation?", listOf("Yes. Janark is operated as a non-profit civic organisation — independent of government and political parties.", "Its purpose is public benefit: a place for citizens to speak, organise, and signal shared needs. It is not a for-profit social network and is not a commercial election or marketing tool.")),
    TermsFaq("responsible", "Is Janark responsible for what people post?", listOf("No. Janark hosts and facilitates civic discussion. Posts, comments, media, links, demands, reports, memes, notices, issues, and votes are created by users.", "Janark does not author those statements, does not adopt them as its own views, and is not liable for their accuracy, legality, fairness, or consequences. You alone are responsible for what you publish under your anonymity ID.")),
    TermsFaq("party", "Can I post in support of a political party or candidate?", listOf("No. Party promotion, candidate campaigning, manifesto pitches, election canvassing, and “vote for / against” party calls are forbidden.", "You may discuss laws, policies, budgets, public services, and institutional performance — without turning the post into partisan advertising.")),
    TermsFaq("topics", "What topics are allowed?", listOf("Civic betterment topics such as judiciary and justice, governance and public policy, education, healthcare, infrastructure, livelihoods, environment, safety, and civic rights — plus similar public-interest subjects.")),
    TermsFaq("anonymous", "If I am anonymous, am I free from responsibility?", listOf("No. Phone OTP helps prove you are a real person and reduces bots. Your number is not shown publicly, but you remain responsible for content published under your anonymity ID.")),
    TermsFaq("verified", "Does a post on Janark mean it is verified or official?", listOf("No. Presence on Janark does not mean the claim was investigated, endorsed, certified, or fact-checked by Janark.", "Trending and ranking reflect civic momentum signals — not court findings or official truth.")),
    TermsFaq("emergency", "Can I use Janark instead of calling the police or filing a case?", listOf("No. Janark is not a police station, court, hospital, or government portal. For emergencies, contact official emergency services.")),
    TermsFaq("false", "What if someone posts something false or harmful about me?", listOf("Users are responsible for their own content. You may flag content that appears to violate these Terms. Flagging does not guarantee removal.")),
    TermsFaq("media", "Who is responsible for GIF and media links I paste?", listOf("You are. You must have the rights to share those links. Third-party hosts are outside Janark’s control.")),
    TermsFaq("moderation", "Will Janark always remove content I report?", listOf("Not necessarily. There is no promise that every flag will lead to removal.")),
    TermsFaq("liability", "What does “platform not responsible” mean in practice?", listOf("To the fullest extent allowed by law, Janark and its operators are not liable for user posts, reliance on rankings, disputes, or most consequential damages.")),
    TermsFaq("accept", "Why must I accept Terms every time I publish?", listOf("Each publication is a fresh confirmation that your specific post complies with the current Terms version.")),
    TermsFaq("binding", "Are FAQ answers legally binding?", listOf("FAQs explain the Terms in plain language. If anything in an FAQ conflicts with the numbered Terms sections, the numbered Terms control.")),
)
